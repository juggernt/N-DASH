...
if($guldenCPU > 0 && $guldenMEM > 0) {
	...
	foreach($gpeerinfo as $innerArray) {
        ...
        if(!isset($subversarray[$subvers])) $subversarray[$subvers] = 0;
        ...
        if(!isset($countryarray[$ipinfo_countryname])) $countryarray[$ipinfo_countryname] = 0;
		$countryarray[$ipinfo_countryname]++;
        if(!isset($cityarray[$ipinfo_cityname])) $cityarray[$ipinfo_cityname] = 0;
