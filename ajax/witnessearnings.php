...
// @4.1		$totalwitnessearnings[$witnesstxearnings['time']] = $witnesstxearnings['amount'];
		if ($witnesstxearnings['vout'] != 0) $totalwitnessearnings[$witnesstxearnings['time']] = $witnesstxearnings['amount']; // @4.1
	}
