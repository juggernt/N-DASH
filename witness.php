...
<div class="row row-offcanvas row-offcanvas-left">
 ...
 <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
    ...
    <ul class="nav nav-sidebar">
      ...
      <li class="active"><a href="?page=witness">Holding</a></li>
 ...
 <div class="col-sm-9 col-md-10 main">
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="addwitnessaccountmodal" id="addwitnessaccountmodal">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title">Create a new holding account</h4>
	      </div>
	...
	<!-- Fund witness account modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="fundwitnessaccountmodal" id="fundwitnessaccountmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title" id="fundingtitle"></h4>
	      </div>
	      
	      <div class="modal-body">
	        <div class="form-group">
		      <label for="selectedwitnessaccount"><small>Selected holder account</small></label><br>
		      <input id="selectedwitnessaccount" name="selectedwitnessaccount" type="text" class="form-control" readonly>
		    </div>
		    <div class="form-group">
		      <label for="selectedguldenaccount"><small>From Novo account</small></label><br>
		      <select name="selectedguldenaccount" id="selectedguldenaccount"></select>
		    </div>
		    <div class="form-group">
		      <label for="lockamount"><small>Amount of Novo to lock</small></label><br>
		      <input id="lockamount" name="lockamount" type="text" class="form-control bfh-number" data-min="50" data-max="999999999">
		    </div>
		    <div class="form-group">
		      <label for="locktime"><small>Time to lock Novo (months)</small></label><br>
		      <div id="slider"><div id="locktime" name="locktime" class="ui-slider-handle"></div></div>
		    </div>
		    <div class="form-group">
		      <label for="lockweight"><small>Your weight (minimum 200; max 1%)</small></label><br>
		      <div id="lockweight" name="lockweight">0 (0%)</div>
		    </div>
		    <div id="extendcriteria" name="extendcriteria"></div>
		    <div id="transactionmessage" name="transactionmessage"></div>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-success" id="lockbutton" onclick="createWitnessDetails();">Lock Novo</button>
	      </div>
	...
	<div id="fundingpopup" class="modal fade" role="dialog">
	  <div class="modal-dialog">
	    <div class="modal-content" name="fundingpopupmodal" id="fundingpopupmodal">
	      ...
	      <div class="modal-body">
	      	<h3>Confirm holder funding</h3>
	        <p>This action cannot be undone.</p>
	        <p>
				<label for="confirmwitnessaccount"><small>Selected holder account</small></label><br>
				<div id="confirmwitnessaccount"></div>
			</p>
			<p>
				<label for="confirmguldenaccount"><small>From Novo account</small></label><br>
				<div id="confirmguldenaccount"></div>
			</p>
			<p>
		      <label for="confirmamount"><small>Amount of Novo to lock</small></label><br>
	...
	<!-- End fund witness account confirmation dialog-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="importwitnessaccountmodal" id="importwitnessaccountmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Import holding account</h4>
	      </div>
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-success" id="importbutton" onclick="importWitnessAccount();">Import holder account</button>
	      </div>
	...
	<!-- Withdraw witness earnings modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="withdrawwitnessaccountmodal" id="withdrawwitnessaccountmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Withdraw holder earnings</h4>
	      </div>
	      
	      <div class="modal-body">
	      	<div class="form-group">
		      <label for="selectedwitnessaccountwithdraw"><small>Selected holder account</small></label><br>
		      <input id="selectedwitnessaccountwithdraw" name="selectedwitnessaccountwithdraw" type="text" class="form-control" readonly>
		    </div>
		    <div class="form-group">
		      <label for="guldenaddresswithdraw"><small>Send to Novo address</small></label><br>
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-success" id="witnesswithdrawbutton" onclick="withdrawWitnessEarnings();">Withdraw holder earnings</button>
	      </div>
	...
	<!-- Show export witness key modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="exportwitnesskeymodal" id="exportwitnesskeymodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <h4 class="modal-title">Export the holder key for this account</h4>
	      </div>
	      
	      <div class="modal-body">
	      	<div class="form-group">
		      <label for="selectedwitnessaccountkey"><small>Selected holder account</small></label><br>
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-success" onclick="showWitnessKey();">Show holder key</button>
	      </div>
	...
	<!-- Delete account modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="deleteaccountmodal" id="deleteaccountmodal">
	      ...
	      <div class="modal-body">
	      	<div class="form-group">
		      <label for="selectedwitnessaccountdelete"><small>Selected holder account</small></label><br>
	...
	<!-- Fund witness account modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="withdrawfundingwitnessaccountmodal" id="withdrawfundingwitnessaccountmodal">
	      ...
	      <div class="modal-body">
	        <div class="form-group">
		      <label for="wifselectedwitnessaccount"><small>Selected holder account</small></label><br>
		      <input id="wifselectedwitnessaccount" name="wifselectedwitnessaccount" type="text" class="form-control" readonly>
		    </div>
		    <div class="form-group">
		      <label for="wifselectedguldenaccount"><small>To Novo account</small></label><br>
	...
	<!-- Witness network charts modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="witnessnetworkmodal" id="witnessnetworkmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <div id="witnessnetworktitle"><h4 class="modal-title">Holding network charts</h4></div>
	      </div>
	...
	<!-- Witness earnings projection charts modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="witnessearningsgraphmodal" id="witnessearningsgraphmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <div id="witnessnetworktitle"><h4 class="modal-title">Holder earnings projection</h4></div>
	      </div>
	...
	<!-- Witness address modal content-->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content" name="witnessaddressmodal" id="witnessaddressmodal">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal">&times;</button>
	        <div id="witnessaddresstitle"><h4 class="modal-title">Holder address</h4></div>
	      </div>
  ...
  <div class="row">
  	<div class="col-md-12">
  		<div class="panel panel-default">
  			<div class="panel-heading" id="witnessnetworkheader">Holder Network</div>
		    <div class="panel-body" id="witnessnetworkpanel">
		    	...
		    	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                        	<div class="text-center">Total Novo Holders</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                        	<div class="text-center">Total Adjusted Weight</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                        	<div class="text-center">Total Novo Locked</div>
                        </div>
                    </div>
                </div>
  ...
  <div class="row">
  	<div class="col-md-3">
  		<div class="panel panel-default">
  			<div class="panel-heading" id="witnessstatusheader">Holder actions</div>
		    <div class="panel-body" id="witnessstatuspanel">
		    	<img src="images/loading.gif" border="0"> Loading....
		    </div>
  		</div>
        <div class="panel panel-default">
            <div class="panel-heading" id="witnessaccountsheader">Holder accounts</div>
