...
class GuldenConsoleRPC {
  //The 'getinfo' command
  public static $getinfo_documentation = "Get Novo-daemon info";
  ...
  //Show the last 50 lines of the Novo debug log
  public static $showlog_documentation = "Show the last 50 lines of the Novo debug log";
  ...
  //The novostop command to shut down Novo-daemon
  public static $guldenstop_documentation = "Stop Novo-daemon graciously";
  public function novostop() {	
    if ($_SESSION['G-DASH-loggedin']==TRUE) {
      include('../../config/config.php');
	  require_once('../../lib/EasyGulden/easygulden.php');
	  $gulden = new Gulden($CONFIG['rpcuser'],$CONFIG['rpcpass'],$CONFIG['rpchost'],$CONFIG['rpcport']);
  ...
  public static $resetdatadirpartial_documentation = "Selectively wipe parts of the data directory and exit Novo-daemon";
  ...
  public static $resetdatadirfull_documentation = "Wipe all blockchain data from the the data directory and exit Novo-daemon";
  ...
  public function help() {
	...
	$availablecommands .= "getinfo - Get Novo-daemon info\n";
	...
	$availablecommands .= "showlog - Show the last 50 lines of the Novo debug log\n";
	...
	$availablecommands .= "walletunlock - Temporary unlock the wallet for Novo services\n";
	...
	$availablecommands .= "novostop - Stop Novo-daemon graciously (i.e. before a reboot)\n";
	$availablecommands .= "resetdatadirpartial - Selectively wipe parts of the data directory and exit Novo-daemon (Can be useful if stuck on a specific block after an upgrade)\n";
	$availablecommands .= "resetdatadirfull - Wipe all blockchain data from the the data directory and exit Novo-daemon. Will cause a full resync to occur which may take some time.\n";
