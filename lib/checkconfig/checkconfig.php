...
if($CONFIG['bcrypt']!="1") {
	$ERRORS[] = "The N-DASH password uses an outdated hashing. Please update your N-DASH password in the 'Settings' screen. Your 
				 password must also be updated if you have disabled the login screen.";
}

//Is the system upgraded and are the settings reviewed?
if($CONFIG['dashversion'] != $NDASH['currentversion']) {
